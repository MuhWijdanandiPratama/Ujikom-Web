<div class="col-sm-3">
  <div class="bg-white border rounded shadow-sm py-4 pr-4 pl-3">
    <h5 class="ml-2">Hi, <?= (session('username')) ? session('username') : '';?></h5>
    <div class="list-group">
      ...
      <?php endif;?>
      <a href="<?= base_url();?>/login/logout" class="list-group-item list-group-item-action border-0 px-0 py-2" onclick="return confirm('Apakah Anda yakin Logout?')"><span class="ml-2 h6 mb-0">Logout</span></a>
    </div>
  </div>
</div>