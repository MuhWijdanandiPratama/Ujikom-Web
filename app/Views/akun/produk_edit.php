    ...
    <div class="bg-white border rounded shadow-sm p-4 h-100">
      ...
      <form action="<?= base_url();?>/akun/produk_edit_act" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control <?= ($validation->hasError('deskripsi_produk')) ? 'is-invalid' : '';?>" id="deskripsi_produk" rows="3" name="deskripsi_produk"><?= (old('deskripsi_produk')) ? old('deskripsi_produk') : $produk['deskripsi_produk'];?></textarea>
            <div class="invalid-feedback">
